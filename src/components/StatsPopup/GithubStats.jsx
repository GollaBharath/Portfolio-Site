						...
						<div className="github-container">
							...
							<div className="repo-card">
								<div className="repos-header">
									<div className="repos-label">PROFILE SUMMARY</div>
								</div>
								<div className="repo-meta">
									<span className="meta-item">
										⑂ Forked Repos:{" "}
										{liveStats.github.repository_metrics?.forked_repos ?? 0}
									</span>
									<span className="meta-item">
										Public Repos: {liveStats.github.user?.public_repos ?? 0}
									</span>
									<span className="meta-item">
										★ Stars:{" "}
										{liveStats.github.repository_metrics?.total_stars ?? 0}
									</span>
									<span className="meta-item">
										Total Forks:{" "}
										{liveStats.github.repository_metrics?.total_forks ?? 0}
									</span>
									<span className="meta-item">
										Followers: {liveStats.github.user?.followers ?? 0}
									</span>
									<span className="meta-item">
										Following: {liveStats.github.user?.following ?? 0}
									</span>
								</div>
							</div>
							...
							<div className="repo-card">
								<div className="repos-header">
									<div className="repos-label">GITHUB STATS</div>
								</div>
								<div className="repo-meta">
									<span className="meta-item">
										Current Streak:{" "}
										{liveStats.github.contribution_signals?.current_streak ?? 0}{" "}
										days
									</span>
									<span className="meta-item">
										Longest Streak:{" "}
									...
									{githubDetailed?.all_time_lines_of_code && (
										<>
											<span className="meta-item">
												Lines Added:{" "}
												{githubDetailed.all_time_lines_of_code.total_lines_added.toLocaleString()}
											</span>
											<span className="meta-item">
												Lines Deleted:{" "}
												{githubDetailed.all_time_lines_of_code.total_lines_deleted.toLocaleString()}
											</span>
											<span className="meta-item">
												Net Lines:{" "}
												{githubDetailed.all_time_lines_of_code.net_lines.toLocaleString()}
											</span>
										</>
									)}
									<span className="meta-item">
										Total Commits:{" "}
										{githubDetailed?.commits_last_365_days?.total_commits ?? 0}{" "}
										(365 days)
									</span>
									<span className="meta-item">
										Total Contributions:{" "}
										{contributions?.total_contributions ?? 0} (365 days)
									</span>
								</div>
							</div>
